...
void PNGAPI
__kimtoy__png_set_crc_action(png_structrp png_ptr, int crit_action, int ancil_action)
{
...
/* Is it OK to set a transformation now?  Only if __kimtoy__png_start_read_image or
 * __kimtoy__png_read_update_info have not been called.  It is not necessary for the IHDR
 * to have been read in all cases; the need_IHDR parameter allows for this
 * check too.
 */
static int
__kimtoy__png_rtran_ok(png_structrp png_ptr, int need_IHDR)
{
   if (png_ptr != NULL)
   {
      if ((png_ptr->flags & PNG_FLAG_ROW_INIT) != 0)
         __kimtoy__png_app_error(png_ptr,
            "invalid after __kimtoy__png_start_read_image or __kimtoy__png_read_update_info");

      else if (need_IHDR && (png_ptr->mode & PNG_HAVE_IHDR) == 0)
         __kimtoy__png_app_error(png_ptr, "invalid before the PNG header has been read");
   ...
   return 0; /* no __kimtoy__png_error possible! */
}
#endif
...
void PNGFAPI
__kimtoy__png_set_background_fixed(png_structrp png_ptr,
    png_const_color_16p background_color, int background_gamma_code,
    int need_expand, png_fixed_point background_gamma)
{
   png_debug(1, "in __kimtoy__png_set_background_fixed");

   if (__kimtoy__png_rtran_ok(png_ptr, 0) == 0 || background_color == NULL)
      return;
...
void PNGAPI
__kimtoy__png_set_background(png_structrp png_ptr,
    png_const_color_16p background_color, int background_gamma_code,
...
void PNGAPI
__kimtoy__png_set_scale_16(png_structrp png_ptr)
{
   png_debug(1, "in __kimtoy__png_set_scale_16");

   if (__kimtoy__png_rtran_ok(png_ptr, 0) == 0)
      return;
...
void PNGAPI
__kimtoy__png_set_strip_16(png_structrp png_ptr)
{
...
void PNGAPI
__kimtoy__png_set_strip_alpha(png_structrp png_ptr)
{
...
void PNGFAPI
__kimtoy__png_set_alpha_mode_fixed(png_structrp png_ptr, int mode,
...
#  ifdef PNG_FLOATING_POINT_SUPPORTED
void PNGAPI
__kimtoy__png_set_alpha_mode(png_structrp png_ptr, int mode, double output_gamma)
{
...
void PNGAPI
__kimtoy__png_set_quantize(png_structrp png_ptr, png_colorp palette,
...
void PNGFAPI
__kimtoy__png_set_gamma_fixed(png_structrp png_ptr, png_fixed_point scrn_gamma,
   png_fixed_point file_gamma)
{
...
#  ifdef PNG_FLOATING_POINT_SUPPORTED
void PNGAPI
__kimtoy__png_set_gamma(png_structrp png_ptr, double scrn_gamma, double file_gamma)
{
 ...
 */
void PNGAPI
__kimtoy__png_set_expand(png_structrp png_ptr)
{
...
void PNGAPI
__kimtoy__png_set_palette_to_rgb(png_structrp png_ptr)
{
...
void PNGAPI
__kimtoy__png_set_expand_gray_1_2_4_to_8(png_structrp png_ptr)
{
...
void PNGAPI
__kimtoy__png_set_tRNS_to_alpha(png_structrp png_ptr)
{
 ...
 */
void PNGAPI
__kimtoy__png_set_expand_16(png_structrp png_ptr)
{
...
void PNGAPI
__kimtoy__png_set_gray_to_rgb(png_structrp png_ptr)
{
...
void PNGFAPI
__kimtoy__png_set_rgb_to_gray_fixed(png_structrp png_ptr, int error_action,
    png_fixed_point red, png_fixed_point green)
{
   ...
   /* TODO: fix this */
   if (__kimtoy__png_rtran_ok(png_ptr, 1) == 0)
      return;
...
void PNGAPI
__kimtoy__png_set_rgb_to_gray(png_structrp png_ptr, int error_action, double red,
   double green)
{
...
void PNGAPI
__kimtoy__png_set_read_user_transform_fn(png_structrp png_ptr, png_user_transform_ptr
...
void /* PRIVATE */
__kimtoy__png_init_read_transformations(png_structrp png_ptr)
{
    ...
    */
   {
      ...
      if (png_ptr->colorspace.gamma != 0) /* has been set */
      {
         if (png_ptr->screen_gamma != 0) /* screen set too */
             ...
             */
            png_ptr->screen_gamma = __kimtoy__png_reciprocal(png_ptr->colorspace.gamma);
      }
          ...
          */
         png_ptr->colorspace.gamma = __kimtoy__png_reciprocal(png_ptr->screen_gamma);
    ...
    */
   if (__kimtoy__png_gamma_significant(png_ptr->screen_gamma) == 0)
   {
      png_ptr->transformations &= ~PNG_ENCODE_ALPHA;
      png_ptr->flags &= ~PNG_FLAG_OPTIMIZE_ALPHA;
   }
   ...
   if ((png_ptr->transformations & PNG_RGB_TO_GRAY) != 0)
      __kimtoy__png_colorspace_set_rgb_coefficients(png_ptr);
#endif
...
#  endif
   ...
   if ((png_ptr->transformations & PNG_GAMMA) != 0 ||
       ((png_ptr->transformations & PNG_RGB_TO_GRAY) != 0 &&
        (__kimtoy__png_gamma_significant(png_ptr->colorspace.gamma) != 0 ||
         __kimtoy__png_gamma_significant(png_ptr->screen_gamma) != 0)) ||
        ((png_ptr->transformations & PNG_COMPOSE) != 0 &&
         (__kimtoy__png_gamma_significant(png_ptr->colorspace.gamma) != 0 ||
          __kimtoy__png_gamma_significant(png_ptr->screen_gamma) != 0
#  ifdef PNG_READ_BACKGROUND_SUPPORTED
         || (png_ptr->background_gamma_type == PNG_BACKGROUND_GAMMA_UNIQUE &&
           __kimtoy__png_gamma_significant(png_ptr->background_gamma) != 0)
#  endif
            ...
            else
            {
               ...
               switch (png_ptr->background_gamma_type)
               {
                  ...
                  case PNG_BACKGROUND_GAMMA_FILE:
                     g = __kimtoy__png_reciprocal(png_ptr->colorspace.gamma);
                     gs = __kimtoy__png_reciprocal2(png_ptr->colorspace.gamma,
                        png_ptr->screen_gamma);
                     break;
               ...
               if (__kimtoy__png_gamma_significant(gs) != 0)
               {
 ...
 */
void /* PRIVATE */
__kimtoy__png_read_transform_info(png_structrp png_ptr, png_inforp info_ptr)
{
   ...
   if ((png_ptr->transformations & PNG_EXPAND) != 0)
   {
      if (info_ptr->color_type == PNG_COLOR_TYPE_PALETTE)
      {
         ...
         if (png_ptr->palette == NULL)
            __kimtoy__png_error (png_ptr, "Palette is NULL in indexed image");
      }
      else
      {
         if (png_ptr->num_trans != 0)
...
png_do_encode_alpha(png_row_infop row_info, png_bytep row, png_structrp png_ptr)
{
    ...
    */
   __kimtoy__png_warning(png_ptr, "png_do_encode_alpha: unexpected call");
}
#endif
 ...
 */
void /* PRIVATE */
__kimtoy__png_do_read_transformations(png_structrp png_ptr, png_row_infop row_info)
{
   ...
   if ((png_ptr->transformations & PNG_RGB_TO_GRAY) != 0)
   {
      ...
      if (rgb_error != 0)
      {
         ...
         if ((png_ptr->transformations & PNG_RGB_TO_GRAY) ==
            ...
            __kimtoy__png_warning(png_ptr, "png_do_rgb_to_gray found nongray pixel");

         if ((png_ptr->transformations & PNG_RGB_TO_GRAY) ==
             PNG_RGB_TO_GRAY_ERR)
            __kimtoy__png_error(png_ptr, "png_do_rgb_to_gray found nongray pixel");
      }
   }
#endif
 ...
 */
...
#endif
      /* Because __kimtoy__png_init_read_transformations transforms the palette, unless
   ...
   if ((png_ptr->transformations & PNG_QUANTIZE) != 0)
   {
      ...
      if (row_info->rowbytes == 0)
         __kimtoy__png_error(png_ptr, "png_do_quantize returned rowbytes=0");
   }
#endif /* READ_QUANTIZE */
