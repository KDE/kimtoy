...
#ifndef SSFENDANALYZER_H
#define SSFENDANALYZER_H
...
class SsfEndAnalyzerFactory;

class SsfEndAnalyzer : public StreamEndAnalyzer
{
public:
    explicit SsfEndAnalyzer(const SsfEndAnalyzerFactory* f);
...
private:
    const SsfEndAnalyzerFactory* const factory;
};

class SsfEndAnalyzerFactory : public StreamEndAnalyzerFactory
{
public:
    virtual const char* name() const;
...
private:
    friend class SsfEndAnalyzer;
    const RegisteredField* idField;
    const RegisteredField* nameField;
    const RegisteredField* versionField;
    const RegisteredField* authorField;
    const RegisteredField* emailField;
    const RegisteredField* timeField;
    const RegisteredField* infoField;
